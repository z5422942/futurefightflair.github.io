...
flair.selectChoice = function (hero_id, key) {
    ...
    flair.by_id[hero_id].hero_attribute = flair.by_id[hero_id].hero_name.replace(/.*?(\#[^)]*\#).*?/g, "$1").replace(/#Combat#/g, "").replace(/#Blast#/g, "").replace(/#Speed#/g, "").replace(/#Universal#/g, "").replace(/#None#/g, "").replace(/#Synergy#/g, "<img src='icons/synergy.png' style='height:20px;' title='Synergy'></img>").replace(/#Buff#/g, "<img src='icons/buff.png' style='height:20px;' title='Buff'></img>").replace(/#Leader#/g, "<img src='icons/leadership.png' style='height:20px;' title='Leadership'></img>").replace(/#Support#/g, "<img src='icons/support.png' style='height:20px;' title='Team Support'></img>").replace(/#PVE5#/g, "<img src='icons/pve5.png' style='height:20px;' title='PVE: Mythic'></img> ").replace(/#PVE4#/g, "<img src='icons/pve4.png' style='height:20px;' title='PVE: Legendary'></img> ").replace(/#PVE3#/g, "<img src='icons/pve3.png' style='height:20px;' title='PVE: Heroic'></img> ").replace(/#PVE2#/g, "<img src='icons/pve2.png' style='height:20px;' title='PVE: Rare'></img> ").replace(/#PVE1#/g, "<img src='icons/pve1.png' style='height:20px;' title='PVE: Advanced'></img> ").replace(/#PVP5#/g, "<img src='icons/pvp5.png' style='height:20px;' title='PVP: Mythic'></img> ").replace(/#PVP4#/g, "<img src='icons/pvp4.png' style='height:20px;' title='PVP: Legendary'></img> ").replace(/#PVP3#/g, "<img src='icons/pvp3.png' style='height:20px;' title='PVP: Heroic'></img> ").replace(/#PVP2#/g, "<img src='icons/pvp2.png' style='height:20px;' title='PVP: Rare'></img> ").replace(/#PVP1#/g, "<img src='icons/pvp1.png' style='height:20px;' title='PVP: Advanced'></img> ");
